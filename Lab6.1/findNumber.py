...
print ("We are going to guess a number between 1 and 30, Please try to find the number")
...
if earlyExit=="TRUE":
	...
	if guessNumber=="exit":
		...
		newFile.write("The number you were looking for was: " + str(surpriseNumber))
else:
