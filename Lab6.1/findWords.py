...
while True:
		try:
			...
			print("Sorry the file was not found, could you please enter again the name of the file: ")
		else:
			myFile.close()
			break

wordToFind=input("Please Enter the word to count or exit for ending the list of words to find: ")
listOfWords=[]
