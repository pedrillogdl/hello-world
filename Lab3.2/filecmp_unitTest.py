...
class TestFilecmp(unittest.TestCase):
	...
	def test_happyPath(self):
		...
		#comparing txt with txt, then a jpg with a jpg, also a jpg with another
		#jpg that is the same file with a different name, then the negative test
		#comparing two different txt, two different jpg  and two different binaries with the same name
	...
	def test_boundary(self):
		#B: Testing boundaries, comparing a file with nothing, entering a wrong argument
		#comparing a file with a file that doesn't exist, missing another argument
	...
	def test_inverse(self):
		#I: Comparing the output of the method with itself, first case is TRUE FALSE, then TRUE TRUE and the end FALSE FALSE 
