...
class TestMathCeil(unittest.TestCase):
	...
	def test_happyPath(self):
		...
		#testing a number near the floor, near the ceil, in the middle, an int number
		#and  then a negative number, also testing that is not going to the floor
	...
	def test_boundary(self):
		#B: Testing the boundaries, an invalid value, a big negative number and a big integer
